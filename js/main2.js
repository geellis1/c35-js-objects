...
console.log(empireStateBuilding[buildingAddress])
...
const partTimeTeacher = nashvilleSoftwareSchool.instructors.partTime
console.log(partTimeTeacher);

//Lightning Exercise 2: Output only Andy and Zoe in the console.

console.log(fullTimeTeacher[4]);
console.log(partTimeTeacher[0]);
